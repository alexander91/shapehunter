 ...
 * 
 * ::To use, call DebugConsoleNGUI.functionOrProperty() where 
...
public class DebugConsoleNGUI : MonoBehaviour
{
    ...
    {                                      
        get
        {
            return DebugConsoleNGUI.instance.visible;
        }
        
        set
        {
            DebugConsoleNGUI.instance.visible = value;
            if (value == true)
            {
                DebugConsoleNGUI.instance.Display();
            }
            else if (value == false)
            {
                DebugConsoleNGUI.instance.ClearScreen();
            }
        }
    }
    ...
    {                                      
        get
        {
            return DebugConsoleNGUI.instance.draggable;
        }
        
        set
        {
            DebugConsoleNGUI.instance.draggable = value;
            
        }
    }
    
    
    private static DebugConsoleNGUI s_Instance = null;   // Our instance to allow this script to be called without a direct connection.
    public static DebugConsoleNGUI instance
    {
        get
        {
            if (s_Instance == null)
            {
                s_Instance = FindObjectOfType(typeof(DebugConsoleNGUI)) as DebugConsoleNGUI;
                if (s_Instance == null)
                {
                    GameObject console = new GameObject();
                    console.AddComponent<DebugConsoleNGUI>();
                    console.name = "DebugConsoleNGUIController";
                    s_Instance = FindObjectOfType(typeof(DebugConsoleNGUI)) as DebugConsoleNGUI;
                    DebugConsoleNGUI.instance.InitGuis();
                }
    ...
    {
        DebugConsoleNGUI.instance.AddMessage(message, color);
        
    }
    //++++ OVERLOAD ++++
    public static void Log(string message)
    {
        DebugConsoleNGUI.instance.AddMessage(message);
    }
    
    public static void Clear()
    {
        DebugConsoleNGUI.instance.ClearMessages();
    }
    //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
