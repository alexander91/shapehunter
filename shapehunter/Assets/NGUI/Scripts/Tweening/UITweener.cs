...
{
    /// <summary>
    /// A hack to turn off update, used for controlling update from outside code
    /// </summary>
    [HideInInspector]
	...
	void Update ()
    {
        // exit if custom timed - hack to update tween from outside
        ...
        UpdateWithGivenDelta(delta);
    }

    /// <summary>
    /// Update with given delta time
    /// </summary>

    public void UpdateWithGivenDelta(float delta)
    {
